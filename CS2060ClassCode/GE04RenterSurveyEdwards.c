...
void getRatings(int rentalSurvey[][RENTERRATING], size_t renters_rows, size_t ratings_colums, int MINRATING, int MAXRATING);
int getValidInt(int MINRATING, int MAXRATING);
void printSurveyResults(const int rentalSurvey[][RENTERRATING], int MINRATING, int MAXRATIN);
...
int getValidInt(MINRATING, MAXRATING) {
